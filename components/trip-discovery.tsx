    ...
    <section className="discovery shell" id="explore">
      ...
      <div className="discovery-layout">
        <div className="discovery-controls">
          ...
          <div className="discovery-field"><div className="fare-target-head"><label htmlFor="discovery-budget">Fare target</label><strong>${budgetValue.toLocaleString()}</strong></div><input id="discovery-budget" className="fare-target-slider" type="range" min="300" max={cabinMax[cabin]} step="50" value={Math.min(Math.max(budgetValue || 300, 300), cabinMax[cabin])} onChange={(event) => setBudget(event.target.value)} aria-label="Maximum fare target" /><div className="fare-target-labels"><span>Lower</span><span>Higher</span></div></div>
