...
export default function AlertBuilder() {
  ...
  const summary = useMemo(() => `${origin || 'MCI'} → ${destinationLabel} · ${cabinLabel} · under $${Number(price || 0).toLocaleString()} · ${frequency}`, [origin, destinationLabel, cabinLabel, price, frequency]);
