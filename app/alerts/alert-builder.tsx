      ...
      <form className="builder-grid" onSubmit={submit}>
        <div className="builder-form">
          <section className="form-section">
            <div className="form-heading"><div><h2>Where are you going?</h2><p>Search by city or airport. If a city has multiple airports, choose the one you want.</p></div></div>
            <label><AirportSearch label="Origin airport" value={originSearch} code={origin} onSelect={(airport) => { setOrigin(airport.iata_code); setOriginSearch(`${airport.municipality || airport.name} (${airport.iata_code})`); }} /></label>
