...
export default function AlertBuilder() {
  ...
  useEffect(() => {
    ...
    if (nextFrequency === 'Weekly' || nextFrequency === 'Monthly') setFrequency(nextFrequency);
