  ...
  return (
    <main>
      <nav className="nav shell">
        <a className="brand" href="/" aria-label="TripSignal home"><span className="brand-mark" />TripSignal</a>
        <div className="nav-actions"><a href="#how">How it works</a><a className="ghost" href="/alerts">Sign in</a><a className="dark" href="/alerts">Get started</a></div>
      </nav>
      <section className="hero shell">
        <div className="hero-copy">
          ...
          <div className="hero-actions"><a className="primary" href="/alerts">Create your first alert <span>→</span></a><a className="text-link" href="#how">See how it works</a></div>
        ...
        <div className="signal-card">
          ...
          <a className="card-button" href="/alerts">Create an alert like this →</a>
        </div>
      </section>
      ...
      <section className="demo shell"><div className="demo-copy"><p className="eyebrow">A BETTER WAY TO SEARCH</p><h2>“Anywhere in Europe.<br />Under $500.”</h2><p>That’s a search TripSignal can handle. No destination grid. No endless date combinations. Just a clear rule and an alert when it happens.</p><a className="primary" href="/alerts">Build an alert <span>→</span></a></div><div className="criteria"><div className="criteria-title">YOUR ALERT</div><div className="criteria-item"><span>FROM</span><strong>Kansas City (MCI)</strong></div><div className="criteria-item"><span>TO</span><strong>Anywhere in Europe</strong></div><div className="criteria-item"><span>PRICE</span><strong>Under $500</strong></div><div className="criteria-item"><span>TRIP</span><strong>7–21 days</strong></div><div className="criteria-item"><span>FREQUENCY</span><strong>Every Monday</strong></div></div></section>
      ...
      <section className="cta shell"><div><p className="eyebrow">TRIPSIGNAL</p><h2>Tell us what a great fare looks like.</h2></div><a className="primary" href="/alerts">Get started <span>→</span></a></section>
