    ...
    <main>
      ...
      <section className="hero shell">
        <div className="hero-copy">
          ...
          <p className="micro">Set it once. We do the searching.</p>
        </div>
      ...
      <section id="how" className="how shell">
        ...
        <div className="steps">
          <article><span>01</span><h3>Define the trip.</h3><p>Choose your origin, destination, dates, cabin, airlines, trip length, stop limit, and target price.</p></article>
          <article><span>02</span><h3>Let us watch.</h3><p>TripSignal checks fares on your schedule and filters out anything that misses the rules you set.</p></article>
          <article><span>03</span><h3>Get the signal.</h3><p>When a qualifying fare appears, you get the route, dates, price, and the information you need to act.</p></article>
        </div>
      </section>

      <section className="demo shell">
        <div className="demo-copy"><p className="eyebrow">A BETTER WAY TO SEARCH</p><h2>“Anywhere in Europe.<br />Under $500.”</h2><p>That is a search TripSignal can handle. No destination grid. No endless date combinations. Just a clear rule and a signal when it happens.</p><a className="button button-light" href="/alerts">Build an alert <span>↗</span></a></div>
