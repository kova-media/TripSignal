  ...
  return (
    <main className="home-page">
      ...
      <section id="how" className="how shell">
        <div className="section-intro"><p className="section-kicker">01 / How it works</p><h2>Search once.<br />Let TripSignal watch.</h2></div>
        <div className="steps"><article><span className="step-number">01</span><h3>Define the trip.</h3><p>Choose the route, dates, cabin, airlines, stops, trip length, and price that work for you.</p></article><article><span className="step-number">02</span><h3>We keep searching.</h3><p>Your watch runs on schedule while TripSignal checks for fares that fit your rules.</p></article><article><span className="step-number">03</span><h3>You get the signal.</h3><p>When a fare qualifies, we send the price, dates, route, and booking path.</p></article></div>
      </section>
      <section className="product-preview shell">
        <div className="preview-heading"><p className="section-kicker">02 / Your watches</p><h2>Keep the search running.</h2><p>Each watch has its own rules. TripSignal checks them on schedule and keeps the result simple.</p></div>
      ...
      <section className="signal-preview shell">
        ...
        <div className="signal-preview-copy"><p className="section-kicker">03 / The signal</p><h2>Useful information.<br />At the right moment.</h2><p>TripSignal filters the noise. You get the fare, dates, route, and details you need to decide, then book directly with the airline or travel provider.</p><a className="text-link" href="/alerts">Build your own criteria <span>↗</span></a></div>
      </section>
      <section className="search-preview shell">
        <div className="search-preview-copy"><p className="section-kicker">04 / Flexible by design</p><h2>Anywhere in Europe.<br />Under $500.</h2><p>Use a broad destination when the fare matters more than the airport. Choose an exact airport when the destination is fixed.</p><a className="button button-primary" href="/alerts">Build your alert <span>↗</span></a></div>
      ...
      <section className="home-cta shell"><div><p className="section-kicker">05 / Start watching</p><h2>Stop searching.<br /><em>Start watching.</em></h2></div><a className="button button-primary" href="/alerts">Create an alert <span>↗</span></a></section>
