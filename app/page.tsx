...
export default async function Home() {
  ...
  return (
    <main className="home-page">
      ...
      <section className="pricing-preview shell" aria-label="TripSignal pricing"><div className="pricing-preview-copy"><p className="section-kicker">TripSignal pricing</p><h2>Search free.<br />Upgrade for unlimited.</h2><p>Create 1 alert each month on the Free plan. That alert stays active and can be checked weekly. Upgrade to TripSignal Pro for unlimited alerts at $19.99 a year.</p></div><div className="pricing-preview-card"><span>Free plan</span><strong>$0</strong><small>1 new alert per month · weekly or monthly checks</small><a className="button button-light" href="/signup">Start free</a><span style={{ marginTop: 28 }}>TripSignal Pro</span><strong>$19.99</strong><small>per year · unlimited alerts · weekly or monthly checks</small><a className="button button-primary" href="/api/billing/checkout">Upgrade to Pro</a></div></section>
      <TripDiscoveryDirect />
